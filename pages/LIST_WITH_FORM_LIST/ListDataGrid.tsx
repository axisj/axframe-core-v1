...
function ListDataGrid({ onClick }: Props) {
  const listColWidths = use$LIST_WITH_FORM_LIST$Store((s) => s.listColWidths);
  const listSortParams = use$LIST_WITH_FORM_LIST$Store((s) => s.listSortParams);
  const listData = use$LIST_WITH_FORM_LIST$Store((s) => s.listData);
  const listPage = use$LIST_WITH_FORM_LIST$Store((s) => s.listPage);
  const listSpinning = use$LIST_WITH_FORM_LIST$Store((s) => s.listSpinning);
  const setListColWidths = use$LIST_WITH_FORM_LIST$Store((s) => s.setListColWidths);
  const setListSortParams = use$LIST_WITH_FORM_LIST$Store((s) => s.setListSortParams);
  const changeListPage = use$LIST_WITH_FORM_LIST$Store((s) => s.changeListPage);
