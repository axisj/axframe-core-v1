...
function ListDataGrid({ onClick }: Props) {
  const listColWidths = use$LIST_WITH_FORM$Store((s) => s.listColWidths);
  const listSortParams = use$LIST_WITH_FORM$Store((s) => s.listSortParams);
  const listData = use$LIST_WITH_FORM$Store((s) => s.listData);
  const listPage = use$LIST_WITH_FORM$Store((s) => s.listPage);
  const listSpinning = use$LIST_WITH_FORM$Store((s) => s.listSpinning);
  const setListColWidths = use$LIST_WITH_FORM$Store((s) => s.setListColWidths);
  const setListSortParams = use$LIST_WITH_FORM$Store((s) => s.setListSortParams);
  const changeListPage = use$LIST_WITH_FORM$Store((s) => s.changeListPage);
